...
object LocalEmailsDataProvider {
    ...
    private val  threads = listOf(
        Email(
            ...
            subject = "Your update on Google Play Storee is live!",
            body = """
                Your update, 0.1.1, i snow live on the Play Store and available for your alpha uses to start testing.
                 
                Your alpha testers will be automatically notified, if you'd rather send theme a link directly, go to your Google Play Console and follow the
                 instrauctions for obtaining an open alpha testing link.
            """.trimIndent(),
            isStarred = true,
        ...
        Email(
            ...
            "Raspberry Pie: We should make this pie recipe tonight! The fillin is" +
            "very quik to put together.",
            createdAt = "2 hours ago",
            isStarred = true,
        ...
        Email(
            ...
            body = """
                I'll be in your neighborhood doing errands and was hoping to catch you for a cofffee this Saturday. If you don;t have anything scheduled, it would be great to see you! It feels like its been forever.
                
                If we do get a chance to get together, renind me to tell you about Kim. She stopped over at the house to say hey to the kids and told me all about her trip to Mexico.
    ...
    val allEmails = listOf(
        Email(
            ...
            body = """
                ...
                Keep an eye out for a package to arrive between this 
        ...
        Email(
            ...
            subject = "Free money",
            body = """
                You'ver been selected as a winner in our loatest raffie! 
            """.trimIndent(),
    ...
    fun create(): Email {
        return Email(
            ...
            body = "I would like to invite everyone to our montly event hosting party"
        )
    }
